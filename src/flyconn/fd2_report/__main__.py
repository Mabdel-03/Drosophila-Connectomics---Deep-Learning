"""CLI: build the Stage-11 FD2 full-circuit report PDF from the FD2 verification JSON.

  python -m flyconn.fd2_report combined \
      [--results "11 - FD2 Identification/fd2_circuit.json"] \
      [--stage "11 - FD2 Identification"] [--with-figures]
...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(prog="flyconn.fd2_report")
    ap.add_argument("command", choices=["combined"], nargs="?", default="combined")
    ap.add_argument("--results", default="11 - FD2 Identification/fd2_circuit.json")
    ap.add_argument("--stage", default="11 - FD2 Identification")
